    ...
    <nav id="navbar" class="fixed top-0 left-0 w-full text-white z-50 flex items-center justify-between px-4 lg:px-5 py-3 transition-all duration-300">
        ...
        <div class="hidden lg:flex">
            <ul class="flex items-center gap-7">
                <li class="text-md font-semibold"><a class="transition-all duration-300 lg:hover:text-gray-300" href="#home">Home</a></li>
                <li class="text-md font-semibold"><a class="transition-all duration-300 lg:hover:text-gray-300" href="#products">Products</a></li>
                <li class="text-md font-semibold"><a class="transition-all duration-300 lg:hover:text-gray-300" href="#newarrivals">New Arrivals</a></li>
                <li class="text-md font-semibold"><a class="transition-all duration-300 lg:hover:text-gray-300" href="#what">What's Hot</a></li>
            </ul>
        </div>
