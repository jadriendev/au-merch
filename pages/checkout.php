...
<body style="font-family: 'Roboto', sans-serif;" class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <main class="flex-1 px-0 sm:px-3">
        <section class="">
            <div class="max-w-7xl mx-auto">
                <div class="nav-links">
                    <a href="../User/homepage" class="blue">Home</a>

                    <div class="arrow">></div>

                    <a href="../pages/checkout" class="">Checkout</a>
                </div>

                <div class="header">
                    <h2 class="">Checkout</h2>
                    <p class="">Complete your purchase by filling in the details below.</p>
                </div>
            </div>
        </section>
                        ...
                        <form id="checkoutForm" action="process_order" method="POST">
                            <div class="first-input">
                                <div class="inputs">
                                    ...
                                    <input class="name" type="text" name="fullname" id="fullname" placeholder="Enter your fullname">
                                </div>

                                <div class="inputs">
                                    <label for="fullname">Phone Number*</label>
                                    <input class="cp" type="number" name="phone" id="phone" placeholder="Enter your phone number">
                                </div>
                            </div>
                            ...
                            <div class="third-input">
                                ...
                                <div class="inputs">
                                    ...
                                    <select class="drop" name="province" id="province">
                                ...
                                <div class="inputs">
                                    ...
                                    <input class="postal" type="number" name="postal" id="postal" placeholder="Enter your postal code">
                                </div>
                            </div>
