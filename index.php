...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4 sm:p-6">
    <main class="flex w-full max-w-5xl min-h-[600px] lg:h-[650px] overflow-hidden bg-white rounded-2xl shadow-xl">
        <div class="hidden lg:block relative w-1/2 overflow-hidden bg-gradient-to-br from-[#49B4E3] via-[#2B95C2] to-[#1B6F94]">
            ...
            <section class="relative z-10 flex h-full flex-col justify-between px-10 py-8">

                <div class="flex items-center gap-3">
                    <img class="w-10" src="https://www.auchiefslms.com/college/pluginfile.php/1/core_admin/logocompact/300x300/1784347206/au-logo-smaller.png" alt="Arellano University Logo">

                    <div>
                        <h3 class="text-lg font-bold text-white">AU Merch</h3>
                        <p class="text-xs text-white/80">Official Merchandise Store</p>
                    </div>
                </div>
                ...
                <div class="space-y-3">
                    <h1 class="text-4xl font-extrabold leading-tight text-white">
                        Wear Your<br>AU Pride
                    </h1>

                    <p class="max-w-md text-sm leading-6 text-white/85">
                        Official Arellano University merchandise designed for students,
                        alumni, faculty, and the entire AU community.
                    </p>
                </div>
            </section>
        </div>

        <form method="POST" class="w-full lg:w-1/2 px-6 sm:px-10 py-5 sm:py-14 flex flex-col justify-start" style="font-family: 'Poppins', sans-serif;">
            <div class="flex items-center justify-center">
                <img class="w-28" src="images/Arellano_University_New_Logo.png" alt="Arellano_University_New_Logo">
            </div>
            <div class="flex flex-col">
                <h1 class="text-2xl text-center mt-2 text-gray-900 font-bold tracking-wide">
                    Welcome to AU Merch
                </h1>

                <p class="text-gray-500 text-sm text-center">
                    Discover exclusive university apparel, accessories, and more all in one place.
                </p>
            </div>

            <div class="flex flex-col gap-5 mt-5">
                <div class="flex flex-col gap-2">
                    <label class="text-sm" for="email">Student ID:</label>
